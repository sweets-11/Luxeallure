  ...
  return (
    <div className="product-search-page">
      ...
      <main>
        ...
        />
        {category === "preowned" ? <span className="preOwnedQuote">Unlock style and sustainability with our premium pre-owned fashion—because great looks shouldn't come at a high cost or environmental impact!</span> : <></>}
        {productLoading ? (
          <Skeleton length={10} />
        ) : (
